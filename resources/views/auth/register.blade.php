            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="postal" class="col-md-4 col-form-label text-md-right">{{ __('code postal') }}</label>

                            <div class="col-md-6">
                                <input id="postal" type="number" class="form-control{{ $errors->has('postal') ? ' is-invalid' : '' }}" name="postal" required>
